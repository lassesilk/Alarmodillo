...
class ViewController: UITableViewController, UNUserNotificationCenterDelegate {
    ...
    fileprivate func createNotifications() {
        ...
        for group in groups {
            ...
            for alarm in group.alarms {
                ...
                center.add(notification) { (err) in
                    if let error = err {
    ...
    fileprivate func createNotificationRequest(group: Group, alarm: Alarm) -> UNNotificationRequest {
    ...
    fileprivate func createNotificationAttachments(alarm: Alarm) -> [UNNotificationAttachment] {
